...
- **Tasks**:
  - [x] Initialize Server (Spring Boot) with `/health` actuator endpoint.
  - [x] Initialize Client (Next.js) displaying "Hello World" from API.
  - [x] Create Dockerfile for both applications.
  - [x] Configure environment variables for database connectivity.
- **Definition of Done (DoD)**:
  - [x] Application is successfully deployed on the K8s cluster.
  - [x] Frontend fetches and displays data from the backend.
  - [x] **Deployment**: Verified on a running cluster.
